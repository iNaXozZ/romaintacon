...
<nav>
        <div class="wrapper collapse navbar-collapse" id="main-navbar">
                            ...
                            <div class="row">
                                ...
                                <?php
                                    foreach($lignes as $ligne){
                                        ...
                                        $_SESSION['arts'] = $ligne;
                                        ?>
                                        <p><a href="<?php echo "front_end/metier.php?id=".$_SESSION['arts']['ID_ART'];  ?>"><?php echo $ligne['TITRE_ART']; ?></a></p>
                                        <?Php
                                        }
                                    }
                                ?>
            ...
            <ul class="nav-links">
                <li>
                    <a href="front_end/connexion_admin.php" class="desktop-item">Administrateur</a>
