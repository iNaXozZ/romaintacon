...
<div id=conteneur>
    <div id=contenu>
        <h2>Connexion</h2>
           ...
           <form method="post" action="../back_end/login_admin.php">
               <table>
                <tr>
                 <td>Identifiant :</td>
                 <td><input type="text" name='COURRIEL_UT' /></td>
                </tr>
                <tr>
                 <td>Mot de passe :</td>
                 <td><input type="password" name='MDP_UT' /></td>
                </tr>
                <tr>
    ...
    <p id=footer>Acceuil - <a href="../index.php">Retour</a></p>
</div>
